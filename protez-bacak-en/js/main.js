/* =========================================================
   Luxmed — Prosthetic Leg (EN) landing — vanilla JS
   ========================================================= */
(function () {
  'use strict';

  /* ---- 1) Hero video: cihaza göre kaynak seç ---- */
  ...
  function loadHeroVideo() {
    ...
    heroVideo.src = src;
    if (heroMedia) heroMedia.setAttribute('data-orient', desktop ? 'landscape' : 'portrait');
  ...
  /* ---- 2) Diğer videoları görünür olunca yükle/oynat (lazy) ---- */
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      // Henüz gerçek anahtar girilmediyse demo modda başarı göster
      ...
      fetch('https://api.web3forms.com/submit', {
        ...
        .then(function (res) {
          ...
          else { alert('Something went wrong. Please WhatsApp us instead.'); btn.disabled = false; btn.textContent = 'Request my free quote'; }
        })
        .catch(function () { alert('Network error. Please WhatsApp us instead.'); btn.disabled = false; btn.textContent = 'Request my free quote'; });
    });
  }

  /* ---- 5) Yıl + Instagram embed ---- */
